...
import { publishPendingFor } from '@hookpost/nestjs-libraries/integrations/social/publish-caveats';
            ...
            {integrations
              ...
              .map((integration) => (
                <div
                  ...
                  {...((toolTip || publishPendingFor(integration.identifier)) && {
                    'data-tooltip-id': 'tooltip',
                    // A channel that cannot publish yet says so here rather than
                    // failing at the scheduled time. See publish-caveats.ts.
                    'data-tooltip-content':
                      publishPendingFor(integration.identifier) ??
                      integration.name,
                  })}
                >
                  <div
                  ...
                  >
                    ...
                    {publishPendingFor(integration.identifier) && (
                      <span
                        className="absolute z-20 -top-[3px] -start-[3px] w-[15px] h-[15px] rounded-full bg-amber-400 border border-black flex items-center justify-center text-[10px] font-extrabold leading-none text-black"
                        aria-label="Cannot publish yet"
                      >
                        !
                      </span>
                    )}
