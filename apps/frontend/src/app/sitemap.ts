...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: Entry[] = [
    ...
    page('/guides/schedule-x-threads', UPDATED.landing2, 0.8, 'monthly'),
    page('/guides/cross-post-x-bluesky', UPDATED.landing2, 0.8, 'monthly'),
    page('/guides/cross-post-dev-articles', UPDATED.landing2, 0.75, 'monthly'),
    page('/alternatives/typefully', UPDATED.landing2, 0.8, 'monthly'),
