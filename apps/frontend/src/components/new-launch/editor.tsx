...
import { BoldText } from '@hookpost/frontend/components/new-launch/bold.text';
import { UText } from '@hookpost/frontend/components/new-launch/u.text';
import { SignatureBox } from '@hookpost/frontend/components/signature';
import { useT } from '@hookpost/react/translation/get.transation.service.client';
import {
  SelectedIntegrations,
  useLaunchStore,
} from '@hookpost/frontend/components/new-launch/store';
import { useShallow } from 'zustand/react/shallow';
import { AddPostButton } from '@hookpost/frontend/components/new-launch/add.post.button';
import { MultiMediaComponent } from '@hookpost/frontend/components/media/media.component';
import { UpDownArrow } from '@hookpost/frontend/components/launches/up.down.arrow';
...
import { Bullets } from '@hookpost/frontend/components/new-launch/bullets.component';
import Heading from '@tiptap/extension-heading';
import { HeadingComponent } from '@hookpost/frontend/components/new-launch/heading.component';
import Mention from '@tiptap/extension-mention';
import { suggestion } from '@hookpost/frontend/components/new-launch/mention.component';
import { useFetch } from '@hookpost/helpers/utils/custom.fetch';
import { AComponent } from '@hookpost/frontend/components/new-launch/a.component';
import { Placeholder } from '@tiptap/extensions';
import { useToaster } from '@hookpost/react/toaster/toaster';
import { InformationComponent } from '@hookpost/frontend/components/launches/information.component';
import {
  LockIcon,
  ConnectionLineIcon,
  ResetIcon,
...
import { DelayComponent } from '@hookpost/frontend/components/new-launch/delay.component';
  ...
  return (
    <div className="flex flex-col gap-[20px] flex-1 min-w-0">
      <div
        ...
        id={id}
      >
        <div className="relative cursor-text flex flex-1 flex-col min-w-0">
          <div {...getRootProps()} className="flex flex-1 flex-col min-w-0">
            <div
              className={clsx(
