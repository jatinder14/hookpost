...
export const AdminErrorsComponent: FC = () => {
  ...
  return (
    <div className="flex flex-col gap-[16px] text-textColor max-w-[1400px] w-full mx-auto">
      {/* Header & Tabs */}
      <div className="flex flex-wrap items-center justify-between gap-[16px]">
        <div>
          <h1 className="text-[24px] font-[700] text-white flex items-center gap-[8px]">
            <span>⚠️</span> Social Network Error Logs
          </h1>
          <p className="text-[13px] opacity-70 mt-[2px]">
            Real-time API errors, rate limit triggers, and platform payloads from social channels.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between mt-[4px]">
        <div className="text-[16px] font-[600]">Error Stream</div>
        <div className="text-[13px] opacity-70">
          {data ? `${data.total} total errors recorded` : ''}
        </div>
      </div>
