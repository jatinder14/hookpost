...
import { StarsAndForks } from '@hookpost/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@hookpost/frontend/components/analytics/stars.table.component';
