...
import { CreateOAuthAppDto } from '@hookpost/nestjs-libraries/dtos/oauth/create-oauth-app.dto';
import { UpdateOAuthAppDto } from '@hookpost/nestjs-libraries/dtos/oauth/update-oauth-app.dto';
...
import { extractBearerToken } from '@hookpost/nestjs-libraries/chat/oauth-types';
