...
# Copilot Coding Agent Instructions for Hookpost
...
- SDK (`apps/sdk`) provides programmatic access to Hookpost features.
...
## Documentation
- Main docs: https://docs.hookpost.com/
- Developer guide: https://docs.hookpost.com/developer-guide
- Public API: https://docs.hookpost.com/public-api
