...
import {
  ...
  ClippingWord,
  ProcessorFailure,
} from '@hookpost/nestjs-libraries/upload/clipping.processor.interface';
...
import { truncateForTemporal } from '@hookpost/nestjs-libraries/integrations/social.abstract';
