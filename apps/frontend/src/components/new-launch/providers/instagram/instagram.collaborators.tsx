...
import { InstagramCollaboratorsTags } from '@hookpost/frontend/components/new-launch/providers/instagram/instagram.tags';
import { InstagramAudioSelector } from '@hookpost/frontend/components/new-launch/providers/instagram/instagram.audio';
...
import { InstagramPreview } from '@hookpost/frontend/components/new-launch/providers/instagram/instagram.preview';
const postType = [
  {
    value: 'post',
    label: 'Post / Reel',
