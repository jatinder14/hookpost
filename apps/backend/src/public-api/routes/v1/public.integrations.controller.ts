...
import { GetIncludeDeletedFromRequest } from '@hookpost/nestjs-libraries/user/include.deleted.from.request';
...
import { GetPostsDto } from '@hookpost/nestjs-libraries/dtos/posts/get.posts.dto';
import { ChangePostStatusDto } from '@hookpost/nestjs-libraries/dtos/posts/change.post.status.dto';
import { UpdatePostSettingsDto } from '@hookpost/nestjs-libraries/dtos/posts/update.post.settings.dto';
import {
  AuthorizationActions,
  Sections,
} from '@hookpost/backend/services/auth/permissions/permission.exception.class';
import { VideoDto } from '@hookpost/nestjs-libraries/dtos/videos/video.dto';
import { VideoFunctionDto } from '@hookpost/nestjs-libraries/dtos/videos/video.function.dto';
import { UploadDto } from '@hookpost/nestjs-libraries/dtos/media/upload.dto';
import { ClippingDto } from '@hookpost/nestjs-libraries/dtos/clipping/clipping.dto';
...
import { GetNotificationsDto } from '@hookpost/nestjs-libraries/dtos/notifications/get.notifications.dto';
import * as Sentry from '@sentry/nestjs';
import {
  socialIntegrationList,
  IntegrationManager,
} from '@hookpost/nestjs-libraries/integrations/integration.manager';
import { getValidationSchemas } from '@hookpost/nestjs-libraries/chat/validation.schemas.helper';
import { RefreshIntegrationService } from '@hookpost/nestjs-libraries/integrations/refresh.integration.service';
import { RefreshToken } from '@hookpost/nestjs-libraries/integrations/social.abstract';
import { PostValidationException } from '@hookpost/backend/api/routes/posts.validation.exception';
...
import { GetOrgActivityDto } from '@hookpost/nestjs-libraries/dtos/analytics/get.org.activity.dto';
...
export class PublicIntegrationsController {
  ...
  async uploadSimple(
    ...
    // Keep the uploader's filename for the media library (upstream drops it).
