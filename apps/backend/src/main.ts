// MUST be the first import: it loads .env and lets the file win over whatever
// is already in process.env. See load-env.ts for why it is a separate module
// (import bodies run before any statement here) and why it overrides.
import './load-env';
